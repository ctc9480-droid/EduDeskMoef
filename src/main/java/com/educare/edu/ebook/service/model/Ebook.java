package com.educare.edu.ebook.service.model;
...
public class Ebook {
	...
	public String getFileRenm() {
		return fileRenm;
	}
	public void setFileRenm(String fileRenm) {
		this.fileRenm = fileRenm;
	}
	public String getThumNm() {
		return thumNm;
	}
	public void setThumNm(String thumNm) {
		this.thumNm = thumNm;
	}
	public String getThumRenm() {
		return thumRenm;
	}
	public void setThumRenm(String thumRenm) {
		this.thumRenm = thumRenm;
	}
}
