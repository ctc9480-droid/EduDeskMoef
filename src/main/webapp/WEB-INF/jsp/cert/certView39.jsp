...
<body>
	<div id="wrap">
		<div class="certi8" id="pdfDiv">
			<h3 class="tl">증서번호 : <span>${certMap.sub.complCertNum }호</span></h3>
			
			<h1>수료증</h1>
			
			<ul class="tl">
				<%-- 
				<li><div class="certiNameTit">소 속</div><div class="pdl3 pdr3">:</div><div class="certiName">${certMap.compNm }</div></li>
				 --%>
				<li><div class="certiNameTit">성 명</div><div class="pdl3 pdr3">:</div><div class="certiName">${certMap.user.userNm}</div></li>
				<li><div class="certiNameTit">생 년 월 일</div><div class="pdl3 pdr3">:</div><div class="certiName">${utcp.convDateToStr(utcp.convStrToDate(certMap.user.birth,'yyyyMMdd'),'yyyy-MM-dd')}</div></li>
				<li><div class="certiNameTit">교 육 기 관</div><div class="pdl3 pdr3">:</div><div class="certiName">한국산업기술시험원</div></li>
				<li><div class="certiNameTit">교 육 과 정</div><div class="pdl3 pdr3">:</div><div class="certiName">의료기기 RA 전문가</div></li>
				<li><div class="certiNameTit">교 육 기 간</div><div class="pdl3 pdr3">:</div><div class="certiName">
			...
			(총 ${certMap.subClassTime }) </div></li>
			</ul>
			
		
			<p class="tl txt1 ls-05" style="font-size: 19px;">
				귀하는 한국산업기술시험원에서 실시한  의료기기 RA전문가 교육을 아래와 같이 이수하였음을 인정합니다.
			</p>
