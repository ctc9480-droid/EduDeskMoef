...
<script language='javascript'>
	function fnSuccProcess(){
		...
		opener.document.getElementById("authTypeNm").value = "IPIN"; 
		opener.document.getElementById("authUserNm").value = "<%= sName %>"; 
		opener.document.getElementById("authBirth").value = "<%= sBirthDate %>"; 
		opener.document.getElementById("authMfType").value = "<%= sGenderCode %>";
		opener.document.getElementById("authEncData").value = "<%= sResponseData %>"; 
