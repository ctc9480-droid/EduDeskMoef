...
<div class="listWrap pdt">
	...
	<c:if test="${'meal' eq vo.boardType }">
	<div class="sub_txt">
		<span class=""><img src="/resources/user/image/icon/icon_subtitle.png" alt="">식단안내</span>
	</div>
	...
	<table class="tb02 mgt30 w100">
		<tr>
			<th width="50px">NO</th>
			<th>제목</th>
			<th width="100px" class="board_writer">작성자</th>
			<th width="100px">작성일</th>
			<th width="50px" style="border-right: 0px;" class="board_hits">조회수</th>
		</tr>
		<c:forEach items="${noticeList }" var="map">
			<tr>
				...
				<td class="board_writer">${map.regNm2 }</td>
				<td class="board_date" >${map.replaceRegDtime('yyyy-MM-dd') }</td>
				<td class="board_hits" style="border-right: 0px;">${map.hit }</td>
			</tr>
		</c:forEach>
