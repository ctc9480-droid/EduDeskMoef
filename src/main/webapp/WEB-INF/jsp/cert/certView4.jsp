...
<body>
	<div id="wrap">
		<div class="certi1" id="pdfDiv">
			<h3 class="tl"><span>합${certMap.sub.passCertNum }</span>호</h3>
			...
			<ul class="tl">
				...
				<li><div class="certiNameTit">과 정 명</div><div class="pdl3 pdr3">:</div><div class="certiName">${certMap.lctre.ctg3Nm }</div></li>
			...
			<p class="tl txt1">
				위 사람은 적합성평가 관리 등에 관한 법률 제17조, KOLAS 전문인력 양성기관 지정 및 교육과정 운영요령 제20조에 따라 실시한 위의 과정을 이수하고 소정의 시험에 합격하였기에 본 증서를 수여합니다.
			</p>
