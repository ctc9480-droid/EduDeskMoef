	...
	<div id="wrap">
		<div class="certi4" id="pdfDiv">
			...
			<table class="tb01">
                <thead>
                    <tr>
                        <th>International Certification Expert Level 1</th>
                        <th>International Certification Expert Level 2</th>
                    </tr>
                </thead>
                <tbody>
                    <tr>
                        <td class="tl">□ Electrical Equipment(CB)</td>
                        <td class="tl">□ Electrical Equipment(CB)</td>
                    </tr>
                    <tr>
                        <td class="tl">□ Medical Devices(CE)</td>
                        <td class="tl">■ Medical Devices(CE)</td>
                    </tr>
                </tbody>
            </table>
			...
			<p class="tl txt2">
				and has been assessed as 'Competent' in the following competency :
			</p>
			<ul class="tl lineStyle">
				<li><b>International Certification Expert Level 1</b> : Ensure that Data analysis ability, Knowledge of International Certification system and Experience based problem solving skills.</li>
				<li><b>International Certification Expert Level 2</b> : Understand that Data analysis ability and Knowledge of International Certification system.</li>
			</ul>
