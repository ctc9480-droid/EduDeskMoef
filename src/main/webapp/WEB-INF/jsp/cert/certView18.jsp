	...
	<div id="wrap">
		<div class="certi6" id="pdfDiv">
			...
			<ul class="tl">
				...
				<li class=""><div class="certiNameTit">교 육 과 정 명 </div><div class="certiNameTiteng">(Course)</div><div class="certiName">GMP 전문가 양성과정</div></li>
				<li><div class="certiNameTit">교 육 분 야 </div><div class="certiNameTiteng">(Field)</div><div class="certiName">제약(Pharmaceutical)</div></li>
