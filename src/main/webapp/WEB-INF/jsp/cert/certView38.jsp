	...
	<div id="wrap">
		<div class="certi8" id="pdfDiv">
			...
			<ul class="tl">
				...
				<li><div class="certiNameTit">성명(생년월일)</div><div class="pdl3 pdr3">:</div><div class="certiName">${certMap.user.userNm} (${utcp.convDateToStr(utcp.convStrToDate(certMap.user.birth,'yyyyMMdd'),'yyyy-MM-dd')})</div></li>
				<li class="line2 line2_2"><div class="certiNameTit">과 정 명</div><div class="pdl3 pdr3">:</div><div class="certiName">시험·검사기관 보수과정(품질관리기준)/</div></li>
			...
			<p class="tl txt1">
				위 사람은 「식품ㆍ의약품분야 시험ㆍ검사 등에 관한 법률」제17조제2항에 따른 시험ㆍ검사 교육을 위와 같이 수료하였으므로 이 증서를 드립니다.
			</p>
