	...
	<table class="tc w100">
		...
		<tbody>
			...
			<tr>
				<td> ${o.email} </td>
				<td> ${o.stdntNm} </td>
				<td> <fmt:formatNumber value="${o.movTime/o.movAllTime }" type="percent" pattern="0.0%"/> </td>
				<td> ${utcp.convDateToStr(o.minRegDate,'yyyy.MM.dd HH:mm:ss')} </td>
			</tr>
			</c:forEach>
		</tbody>
	</table>
