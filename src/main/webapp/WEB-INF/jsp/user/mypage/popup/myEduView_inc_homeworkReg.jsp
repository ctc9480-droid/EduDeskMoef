...
<div class="popWrite">
    <form method="post" id="eduCommunityRegForm">
    	<input type="hidden" id="boardType" name="boardType" value="eduHomework" /> 
        ...
        <table class="tb04">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <input type="radio" name="scrtyYn" id="scrtyYn1" value="N" ${lectureCommunity.scrtyYn ne 'Y'?'checked':'' }/><label for="scrtyYn1">공개</label>
                        <input type="radio" name="scrtyYn" id="scrtyYn2" value="Y" ${lectureCommunity.scrtyYn eq 'Y'?'checked':'' }/><label for="scrtyYn2">비공개</label>
                    </td>
                </tr>
                <tr>
                    <th scope="row">내용</th>
