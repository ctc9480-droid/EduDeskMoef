 ...
 */
@Controller
@RequestMapping(value="/user/cnhtml/")
public class CnhtmlUserController {
	...
	@RequestMapping("cnht_{cnhtType}.do")
	public String accipList(ModelMap model,HttpServletRequest request
			,@PathVariable String cnhtType
			) {
		String cnhtTypep = cnhtType;
		ResultVO result = cnhtmlService.getCnhtmlDataByActive(cnhtTypep);
		model.addAttribute("result",result);
		return "/user/cnhtml/view"+LncUtil.TILES;
	}
