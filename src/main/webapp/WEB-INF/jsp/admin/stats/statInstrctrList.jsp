	...
	<table class="w100 tb01">
		...
		<thead>
			<tr>
				...
				<th  scope="col" class="vm">교육대분류</th>
				<th  scope="col" class="vm">교육세분류</th>
				<th  scope="col" class="vm">강사명</th>
				<th  scope="col" class="vm">강의시간</th>
				<th  scope="col" class="vm">강사등급</th>
				<th  scope="col" class="vm">강사료</th>
			</tr>
		</thead>
		<tbody>
	...
	<table class="w100 tb01">
		...
		<thead>
			<tr>
				...
				<th  scope="col" class="vm">강사명</th>
				<th  scope="col" class="vm">강사등급</th>
				<th  scope="col" class="vm">총 교육과정 수</th>
				<th  scope="col" class="vm">총 강의 시간</th>
				<th  scope="col" class="vm">총 강사료</th>
			</tr>
		</thead>
		<tbody>
			<c:forEach var="o" items="${data.pageList2}" varStatus="s">
				<tr>
					<td>${s.count }</td>
					<td>${o.checkNm }</td>
					<td></td>
