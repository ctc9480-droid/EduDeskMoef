	<%--ext JS --%>
	<script type="text/javascript" src="${utcp.ctxPath}/gpkisecureweb/client/GPKIWeb/js/ext/jquery-1.10.2.js"></script>
	<script type="text/javascript" src="${utcp.ctxPath}/gpkisecureweb/client/GPKIWeb/js/ext/jquery-ui.min.js"></script>
	<script type="text/javascript" src="${utcp.ctxPath}/gpkisecureweb/client/GPKIWeb/js/ext/jquery.blockUI.js"></script>
	<script type="text/javascript" src="${utcp.ctxPath}/gpkisecureweb/client/GPKIWeb/js/ext/json2.js"></script>
	...
	<script type="text/javascript" src="${utcp.ctxPath}/gpkisecureweb/client/GPKIErrorText.js" ></script>
