	...
	<div id="wrap">
		<div class="certi6" id="pdfDiv">
			...
			<ul class="tl">
				...
				<li class=""><div class="certiNameTit">교 육 과 정 명 </div><div class="certiNameTiteng">(Course)</div><div class="certiName">해외인증 전문가 과정</div></li>
				<li><div class="certiNameTit">교 육 분 야 </div><div class="certiNameTiteng">(Field)</div><div class="certiName">전기전자(CB)</div></li>
			...
			<p class="tc txt1">
				...
				<b>'International Certification Expert Course'</b>
			</p>
			<div class="bot_Cname">
