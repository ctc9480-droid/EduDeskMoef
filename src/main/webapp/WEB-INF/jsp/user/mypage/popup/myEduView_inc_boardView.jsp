...
<!--// view //-->
<div class="tstyle_view" id="vm-edu-board">
	<div class="title">${lectureBoard.title }</div>
	<ul class="head info">
		<li>
			<span>작성일</span> <b>${utcp.convDateToStr(utcp.convStrToDate(lectureBoard.regDtime,'yyyyMMddHHmmssSSS'),'yyyy.MM.dd')}</b>
		</li>
		<li>
			<p></p> <span>조회수</span> <b>${lectureBoard.hit}</b>
		</li>
		<li>
			<p></p> <span>작성자</span> <b>${lectureBoard.regNm}</b>
		</li>
		<c:forEach items="${attachList }" var="o">
			<li>
				<a href="${utcp.ctxPath}/user/mypage/popup/download/${o.fileSeq}.do">
					<p></p> <img src="${utcp.ctxPath}/resources/user/image/icon/down_icon.gif" alt="파일 아이콘" class="vm"/> <b>${o.fileOrg }</b>
				</a>
			</li>
		</c:forEach>
...
<div class="tb_btn cf">
	<a href="javascript:fn_boardList();" class="btn02 btn_grayl fl">목록</a>
</div>
