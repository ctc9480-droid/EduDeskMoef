			...
			<li class="flex" >
				...
				<div class="text_title">
					<div class="cp" :onclick="'fn_moveView('+o.eduSeq+');'" style="cursor: pointer">
						...
						<p class="eduSbj">
						<strong v-html="o.eduNm+' '+o.eduTerm+'차수'"></strong>
						<span v-html="o.addStatusBox "></span>
						</p>
						<p class="eduStnt">대상 : <span class="Stnt" >
						<span v-html="o.addTargetTpNm"></span>
				...
				<div class="text_info">
					<div>
						<span class="edudtType1"> [접수] <b class=""> 
						...
						<span class="edudtType2"> [교육] <b class="">{{o.eduPeriodBegin}}
						<template v-if="o.eduPeriodBegin != o.eduPeriodEnd">
						 ~ {{o.eduPeriodEnd}}
						 </template>
						</b>
						</span>
						<span class="edudtType3"> [인원]
