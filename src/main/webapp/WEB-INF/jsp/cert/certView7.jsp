...
<body>
	<div id="wrap">
		<div class="certi3" id="pdfDiv">
			...
			<p class="tl txt1">
				<span class="dp_b">□ Quality Control Engineer</span>
				<span class="dp_b">▣ Quality Engineer</span>
				<span class="dp_b">□ Quality Master Engineer</span>
			</p>
			<p class="tl txt2">
			...
			<ul class="tl lineStyle">
				<li><b>Quality Control Engineer</b> : Ensure that products meet standards of quality and safety.</li>
				<li><b>Quality Engineer</b> : Understand the principles of product and service quality evaluation and control.</li>
				<li><b>Quality Master Engineer</b> : Support of lead quality improvement initiatives.</li>
			</ul>
