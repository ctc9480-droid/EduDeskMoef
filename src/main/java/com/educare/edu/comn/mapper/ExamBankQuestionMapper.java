 ...
 * 
 */
@Mapper("ExamBankQuestionMapper")
public interface ExamBankQuestionMapper {

	void insertByPk(ExamBankQuestion param);

	ExamBankQuestion selectByPk(ExamBankQuestion ebqParam);

	void updateByPk(ExamBankQuestion ebqParam);
