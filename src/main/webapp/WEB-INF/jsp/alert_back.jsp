...
<body onload="fn_load();">
	...
	<div id="wrapper" class="cf">	
		<!--// popup_message //-->
		<div class="remodal messagePop messagePop1" data-remodal-id="message" role="dialog" aria-labelledby="modal1Title" aria-describedby="modal1Desc" data-remodal-options="closeOnOutsideClick: false">
			<div class="modal-content">
				...
				<div class="modal-footer">
					<div class="tc">
						<button onclick="fn_move(); return false;" class="remodal-confirm btn02 btn_green">확인</button>
					</div>
				</div>
			</div>
		</div>
