...
<body>
	<div id="wrap">
		<div class="certi1" id="pdfDiv">
			<h3 class="tl"><span>수${certMap.sub.complCertNum }</span>호</h3>
			...
			<p class="tl txt1">
				위 사람은 적합성평가 관리 등에 관한 법률 제17조, KOLAS 전문인력 양성기관 지정 및 교육과정 운영요령 제20조에 따라 실시한 위의 교육과정을 이수하였기에 본 증서를 수여합니다. 
			</p>
