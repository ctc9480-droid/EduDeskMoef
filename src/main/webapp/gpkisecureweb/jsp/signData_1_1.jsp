		...
		<div class="course course1">
			...
			<div class="list_01">
				<ul>
					...
					<li><span>&nbsp;&nbsp;&nbsp;<font color="blue">서명할 데이터는 안전한 데이터 전송을 위해 <b>Base64 Encoding String</b>을 사용하세요.</font><br/>&nbsp;&nbsp;&nbsp;파라미터로 전달된 파라미터에 대해 웹브라우저에서 전자서명 데이터를 생성합니다.<br/>
				...
				<div class="form">
					<form name="signSession">
						...
						<input type="button" value="전자서명 메시지 생성" onClick="SignedData(this,document.signSession.orgData.value+'_'+'<%=sessionid%>')" style="margin-left:30px; margin-top:10px; height:30px; width:200px;"/>
					...
					<input type="button" onClick="postSignedDataToServer(signSession.signedDataValue.value);" style="margin-left:30px; margin-top:10px; height:30px; width:200px;" value="전자서명 메시지 전송"/>
				</div>
			</div>
		</div>	
		<div class="sp"></div>
