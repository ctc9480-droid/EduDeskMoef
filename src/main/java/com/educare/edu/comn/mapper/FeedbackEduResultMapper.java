...
@Mapper("FeedbackEduResultMapper") 
public interface FeedbackEduResultMapper {

	FeedbackEduResult selectByPk(FeedbackEduResult vo);

	void updateByPk(FeedbackEduResult vo);

	void insertByPk(FeedbackEduResult vo);

	void deleteByPk(FeedbackEduResult vo);

	int selectCnt(FeedbackEduResult vo);
