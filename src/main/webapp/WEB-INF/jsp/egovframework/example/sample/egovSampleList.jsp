...
<head>
    ...
    <link type="text/css" rel="stylesheet" href="${utcp.ctxPath }/css/egovframework/sample.css"/>
    <script type="text/javaScript" language="javascript" defer="defer">
        <!--
        /* 글 수정 화면 function */
        function fn_egov_select(id) {
        	document.listForm.selectedId.value = id;
           	document.listForm.action = "${utcp.ctxPath }/updateSampleView.do";
           	document.listForm.submit();
        }
        
        /* 글 등록 화면 function */
        function fn_egov_addView() {
           	document.listForm.action = "${utcp.ctxPath }/addSample.do";
           	document.listForm.submit();
        }
        
        /* 글 목록 화면 function */
        function fn_egov_selectList() {
        	document.listForm.action = "${utcp.ctxPath }/egovSampleList.do";
           	document.listForm.submit();
        }
...
<body style="text-align:center; margin:0 auto; display:inline; padding-top:100px;">
    <form:form commandName="searchVO" id="listForm" name="listForm" method="post">
        ...
        <div id="content_pop">
        	...
        	<div id="title">
        		<ul>
        			<li><img src="${utcp.ctxPath }/images/egovframework/example/title_dot.gif" alt=""/><spring:message code="list.sample" /></li>
        		</ul>
        	</div>
        	<!-- // 타이틀 -->
        	<div id="search">
        		<ul>
        			...
        			<li>
        	            <span class="btn_blue_l">
        	                ...
        	                <img src="${utcp.ctxPath }/images/egovframework/example/btn_bg_r.gif" style="margin-left:6px;" alt=""/>
        	            </span>
        	        </li>
                </ul>
        	</div>
