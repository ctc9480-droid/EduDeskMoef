...
<script>
	...
	function fn_popup_preview(idx,posX,posY,width,height) {
		window.open('${utcp.ctxPath}/bbs/comm/popup/open.do?idx=' + idx, 'popup_'+idx,
				'status=0,location=0,left='+posX+',top='+posY+',width='+width+',height='+height+'');
	}
</script>
<section class="pd025 pd200 po_re">
	<div class="po_re br5 bs_box">
		...
		<table width="100%" class="tb01 tc tb_fix">
			...
			<tbody>
				<c:forEach items="${popupList }" var="map" varStatus="s">
					<tr>
						...
						<td><a href="#none" onclick="fn_popup_preview('${map.idx}',${map.posX },${map.posY },${map.width },${map.height })"> <i class="fas fa-search font_16 fc_gray"></i>
						</a></td>
					</tr>
				</c:forEach>
