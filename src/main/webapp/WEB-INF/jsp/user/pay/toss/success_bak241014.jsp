...
<html lang="ko">
  <head>
    ...
    />
    <link rel="stylesheet" type="text/css" href="${utcp.ctxPath }/resources/pay/toss/style.css" />
  ...
  <body>
    ...
    <script>
      ...
      async function confirm() {
        ...
        const response = await fetch("${utcp.ctxPath}/user/pay/toss/confirm.ajax", {
          method: "POST",
          headers: {
